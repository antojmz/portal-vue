! function(t) {
    ...
    var s = n(6),
        ...
        o = function() {
            function t(e) {
                r(this, t), this.setAlignment(e.align), this.label = e.label || "", this.field = e.field || null, this.representedAs = e.representedAs || null, this.component = e.component || null, this.interpolate = e.interpolate || !1, this.sortable = this.isSortable(e), this.filterable = this.isFilterable(e)
            }
            return a(t, [{
                key: "setAlignment",
                value: function(t) {
